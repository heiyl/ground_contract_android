...
import static com.common.library.tools.grant.PermissionsPageManager.MANUFACTURER_HUAWEI;
import static com.common.library.tools.grant.PermissionsPageManager.MANUFACTURER_MEIZU;
import static com.common.library.tools.grant.PermissionsPageManager.MANUFACTURER_OPPO;
import static com.common.library.tools.grant.PermissionsPageManager.MANUFACTURER_VIVO;
import static com.common.library.tools.grant.PermissionsPageManager.MANUFACTURER_XIAOMI;
...
public class ManufacturerSupportUtil {
    ...
    private static String[] underMHasPermissionsRequestManufacturer = {MANUFACTURER_XIAOMI,
            MANUFACTURER_MEIZU, MANUFACTURER_OPPO, MANUFACTURER_VIVO, MANUFACTURER_HUAWEI};
