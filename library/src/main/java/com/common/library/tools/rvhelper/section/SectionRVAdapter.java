           ...
           if (viewType >= entry.getValue() && viewType < entry.getValue() + VIEW_TYPE_QTY) {
               ...
               switch (sectionViewType) {
                   case VIEW_TYPE_HEADER: {
                       ...
                       if (resId == null)
                           throw new NullPointerException("Missing 'header' resource examId");
                   ...
                   case VIEW_TYPE_FOOTER: {
                       ...
                       if (resId == null)
                           throw new NullPointerException("Missing 'footer' resource examId");
                   ...
                   case VIEW_TYPE_LOADING: {
                       ...
                       if (resId == null)
                           throw new NullPointerException("Missing 'loading state' resource examId");
                   ...
                   case VIEW_TYPE_FAILED: {
                       ...
                       if (resId == null)
                           throw new NullPointerException("Missing 'failed state' resource examId");
